...
import sys
from typing import (Callable, Final, Iterable, Iterator, List, Optional,
                    Pattern, Set, Tuple, Union, cast)

from blib2to3.pgen2.grammar import Grammar
from blib2to3.pgen2.token import (ASYNC, AWAIT, COMMENT, DEDENT, ENDMARKER,
                                  ERRORTOKEN, INDENT, NAME, NEWLINE, NL,
                                  NUMBER, OP, STRING, tok_name)
